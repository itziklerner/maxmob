        ...
        var methods = {
            ...
            init: function(options, callback) {
                ...
                return $(this).each(function() {
                    ...
                    /*handler.die(".jqiphoneslide");
                    $(opts.prevPageHandler).die("click.jqiphoneslide", __slidePrevPage, false);
                    $(opts.nextPageHandler).die("click.jqiphoneslide", __slideNextPage, false);*/
                    handler.die();
                    /*handler.live("mousedown.jqiphoneslide", __mouseDown, false)
                            .live("touchstart.jqiphoneslide", __mouseDown)
                            .live("click.jqiphoneslide", function(event) {
                    ...
                    var __mouseDown = function(event) {
                        ...
                        if (opts.slideHandler === null || typeof opts.slideHandler !== "string") {
                            handler.live("mousemove.jqiphoneslide touchmove.jqiphoneslide", __mouseMove, false)
                                .live("mouseleave.jqiphoneslide mouseup.jqiphoneslide touchend.jqiphoneslide touchcancel.jqiphoneslide", __mouseUp, false);
                        } else {
                            handler.filter(opts.slideHandler).live("mousemove.jqiphoneslide touchmove.jqiphoneslide", __mouseMove, false)
                                .live("mouseleave.jqiphoneslide mouseup.jqiphoneslide touchend.jqiphoneslide touchcancel.jqiphoneslide", __mouseUp, false);
                        }
                    };
                    ...
                    var __mouseUp = function(event) {
                        ...
                        if (opts.slideHandler === null || typeof opts.slideHandler !== "string") {
                            //handler.die("mousemove.jqiphoneslide touchmove.jqiphoneslide", __mouseMove, false);
                            handler.die();
                            handler.live("mousedown.jqiphoneslide", __mouseDown, false)
                            .live("touchstart.jqiphoneslide", __mouseDown)
                            .live("click.jqiphoneslide", function(event) {
                            ...
                            //handler.filter(opts.slideHandler).die("mousemove.jqiphoneslide touchmove.jqiphoneslide", __mouseMove, false);
                            handler.filter(opts.slideHandler).die();
                            handler.filter(opts.slideHandler).live("mousedown.jqiphoneslide", __mouseDown, false)
                            .live("touchstart.jqiphoneslide", __mouseDown)
                            .live("click.jqiphoneslide", function(event) {
                                if(__preventClickEvent) {
                                    __preventClickEvent = false;
                        ...
                        if (opts.slideHandler === null || typeof opts.slideHandler !== "string") {
                            //$(this).die("mouseleave.jqiphoneslide mouseup.jqiphoneslide touchend.jqiphoneslide", __mouseUp, false);
                            $(this).die();
                            $(this).live("mousedown.jqiphoneslide", __mouseDown, false)
                            .live("touchstart.jqiphoneslide", __mouseDown)
                            .live("click.jqiphoneslide", function(event) {
                                if(__preventClickEvent) {
                                    __preventClickEvent = false;
                            ...
                            //$(this).filter(opts.slideHandler).die("mouseleave.jqiphoneslide mouseup.jqiphoneslide touchend.jqiphoneslide", __mouseUp, false);
                            $(this).filter(opts.slideHandler).die();
                            $(this).filter(opts.slideHandler).live("mousedown.jqiphoneslide", __mouseDown, false)
                            .live("touchstart.jqiphoneslide", __mouseDown)
                            .live("click.jqiphoneslide", function(event) {
                                if(__preventClickEvent) {
                                    __preventClickEvent = false;
                    ...
                    if(opts.slideHandler === null || typeof opts.slideHandler !== "string") {
                        handler
                            .live("mousedown.jqiphoneslide", __mouseDown, false)
                            .live("touchstart.jqiphoneslide", __mouseDown)
                            .live("click.jqiphoneslide", function(event) {
                                if(__preventClickEvent) {
                                    __preventClickEvent = false;
                        ...
                        handler.filter(opts.slideHandler)
                            .live("mousedown.jqiphoneslide touchstart.jqiphoneslide", __mouseDown, false)
                            .live("touchstart.jqiphoneslide", __mouseDown, false)
                            .live("click.jqiphoneslide", function(event) {
                                if(__preventClickEvent) {
                                    __preventClickEvent = false;
                                    event.stopImmediatePropagation();
                    ...
                    $(opts.nextPageHandler).live("click.jqiphoneslide", __slideNextPage, false);
                    $(opts.prevPageHandler).live("click.jqiphoneslide", __slidePrevPage, false);
